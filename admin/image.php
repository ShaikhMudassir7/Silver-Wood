                ...
                <div class="modal fade" id="modalAddImage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="backend/image-backend" id="imageForm" enctype="multipart/form-data">
                                ...
                                <div class="modal-footer d-flex justify-content-center">
                                    <button class="btn btn-primary" name="add" id="addimage">Add Image</button>
                                </div>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="modal fade" id="modalEditImage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center">
                            ...
                            <form method="POST" action="backend/image-backend" id="imageEditForm" enctype="multipart/form-data">
                                <div class="container repeater-container edit-container">
                                    <!-- Auto Generated Content -->
                                </div>
                                <div class="modal-footer d-flex justify-content-center">
                                    <button class="btn btn-primary" name="edit" id="editimage">Edit Image</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left media-middle col-6">
                                            ...
                                            <p class="card-description">
                                                List of images currently on the system
                                            </p>
                                        </div>
                                        <div class="media-right media-middle col-6">
                                            <button class="btn" style="float: right;background-color:rgb(66,133,244);color: white;" data-toggle="modal" data-target="#modalAddImage"><i class="fas fa-plus-circle"></i> Add Image</button>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left media-middle col-6">
                                    ...
                                    <div class="col-12 col-sm-12 col-lg-12">
                                        <div class="table-responsive">
                                            <table class="table" id="imageTable">
                                                ...
                                                $content = fetchPagination("i.id,i.image,a.name as `category`,i.date", "`image` AS i", "INNER JOIN `album` AS a ON i.`category` = a.id WHERE $search ORDER BY i.`id` DESC");
                                                $i = -1;
                                                $totalentries = 0;
                                                if ($content > 0) {
                                                ...
                                                ?>
                                                        <tr id="<?php echo $row['id']; ?>" class="selectable" data-id="<?php echo $row['id']; ?>" data-tag="image" data-name="in '<?php echo $row['category']; ?>' category">
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                            ...
                                                            <td><img src="../assets/img/thumb/<?php echo $row['image']; ?>" data-image="../assets/img/image/<?php echo $row['image']; ?>" width="40px" alt="" class="imageresource"></td>
                                                            <td><?php echo $row['category']; ?></td>
                                                            <td><?php echo Date("d M Y", strtotime($row['date'])); ?></td>
                                                            <td>
                                                                <span data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <a class="update" data-toggle="modal" data-target="#modalEditImage">
