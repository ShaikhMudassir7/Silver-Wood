...
<head>
    ...
    <title>Testimonial | SILVERWOOD</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="main-panel">
                <div class="modal fade" id="modalAddTestimonial" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center">
                                <h4 class="modal-title w-100 font-weight-bold">Add New Testimonial</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form method="POST" action="backend/testimonial-backend">
                                        ...
                                        <div class="media">
                                            <div class="col-lg-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="testimonial[]" id="testimonial" class="form-control" placeholder="Testimonial Details" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer d-flex justify-content-center">
                                    <button class="btn btn-primary" name="add" id="addtestimonial">Add Testimonial</button>
                                </div>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="modal fade" id="modalEditTestimonial" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center">
                            ...
                            <form method="POST" action="backend/testimonial-backend">
                                ...
                                <div class="modal-footer d-flex justify-content-center">
                                    <button class="btn btn-primary" name="edit" id="edittestimonial">Edit Testimonial</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-left media-middle col-6">
                                            ...
                                            <p class="card-description">
                                                List of testimonials currently on the system
                                            </p>
                                        </div>
                                        <div class="media-right media-middle col-6">
                                            <button class="btn" style="float: right;background-color:rgb(66,133,244);color: white;" data-toggle="modal" data-target="#modalAddTestimonial"><i class="fas fa-plus-circle"></i> Add Testimonial</button>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left media-middle col-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <span class="selectedOptions d-none">
                                            <span data-toggle="modal" data-target="#modalEditTestimonial">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="testimonialTable">
                                                ...
                                                if (isset($_GET['search'])) {
                                                    $search = "CONCAT_WS(`testimonial`, DATE_FORMAT(`time`, '%d-%M-%Y')) LIKE '%" . secure($_GET['search']) . "%'";
                                                } else {
                                                    $search = "1";
                                                }
                                                $content = fetchPagination("*", "`testimonial`", "WHERE $search ORDER BY `id` DESC");
                                                $i = -1;
                                                $totalentries = 0;
                                                if ($content > 0) {
                                                ...
                                                ?>
                                                        <tr id="<?php echo $row['id']; ?>" class="selectable" data-id="<?php echo $row['id']; ?>" data-tag="testimonial" data-name="<?php echo $row['title']; ?>">
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                            ...
                                                            <td><?php echo $row['testimonial']; ?></a></td>
                                                            <td><?php echo Date("d M Y", strtotime($row['time'])); ?></td>
                                                            <td>
                                                                <span data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <a class="update" data-toggle="modal" data-target="#modalEditTestimonial">
