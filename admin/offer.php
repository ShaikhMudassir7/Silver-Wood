                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center">
                                <h4 class="modal-title w-100 font-weight-bold">Add New Offer</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form method="POST" action="backend/offer-backend">
                                        ...
                                        <div class="media">
                                            <div class="col-lg-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title[]" id="title" class="form-control" placeholder="Offer Title" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="lname">Offer:</label><br>
                                                    <textarea name="offer[]" id="offer" class="form-control" placeholder="Offer Details" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer d-flex justify-content-center">
                                    <button class="btn btn-primary" name="add" id="addoffer">Add Offer</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="backend/offer-backend">
                                ...
                                <div class="modal-footer d-flex justify-content-center">
                                    <button class="btn btn-primary" name="edit" id="editoffer">Edit Offer</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="media-left media-middle col-6">
                                            ...
                                            <p class="card-description">
                                                List of offers currently on the system
                                            </p>
                                        </div>
                                        <div class="media-right media-middle col-6">
                                            <button class="btn" style="float: right;background-color:rgb(66,133,244);color: white;" data-toggle="modal" data-target="#modalAddOffer"><i class="fas fa-plus-circle"></i> Add Offer</button>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="media-left media-middle col-6">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <span class="selectedOptions d-none">
                                            <span data-toggle="modal" data-target="#modalEditOffer">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="offerTable">
                                                ...
                                                if (isset($_GET['search'])) {
                                                    $search = "CONCAT_WS(`title`, `offer`, DATE_FORMAT(`time`, '%d-%M-%Y')) LIKE '%" . secure($_GET['search']) . "%'";
                                                } else {
                                                    $search = "1";
                                                }
                                                $content = fetchPagination("*", "offer", "WHERE $search ORDER BY `id` DESC");
                                                $i = -1;
                                                $totalentries = 0;
                                                if ($content > 0) {
                                                ...
                                                ?>
                                                        <tr id="<?php echo $row['id']; ?>" class="selectable" data-id="<?php echo $row['id']; ?>" data-tag="offer" data-name="<?php echo $row['title']; ?>">
                                                            <td>
                                                                <div class="custom-control custom-checkbox">
                                                            ...
                                                            <td><?php echo $row['offer']; ?></a></td>
                                                            <td><?php echo Date("d M Y", strtotime($row['time'])); ?></td>
                                                            <td>
                                                                <span data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <a class="update" data-toggle="modal" data-target="#modalEditOffer">
